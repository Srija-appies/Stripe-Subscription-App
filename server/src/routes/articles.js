...
router.get("/", checkAuth_1.checkAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, subscriptions, plan, articles, articles, articles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (!(plan === "Basic")) return [3 /*break*/, 4];
                return [4 /*yield*/, article_1.default.find({ access: "Basic" })];
            case 3:
                articles = _a.sent();
                return [2 /*return*/, res.json(articles)];
            case 4:
                if (!(plan === "Standard")) return [3 /*break*/, 6];
            ...
            case 5:
                articles = _a.sent();
                return [2 /*return*/, res.json(articles)];
            case 6: return [4 /*yield*/, article_1.default.find({})];
            case 7:
                articles = _a.sent();
                return [2 /*return*/, res.json(articles)];
            case 8:
