...
router.get("/prices", checkAuth_1.checkAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var prices;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, stripe_1.stripe.prices.list({
                    apiKey: process.env.STRIPE_SECRET_KEY,
                })];
            case 1:
                prices = _a.sent();
                return [2 /*return*/, res.json(prices)];
        }
    });
}); });
router.post("/session", checkAuth_1.checkAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, session;
    return __generator(this, function (_a) {
        switch (_a.label) {
